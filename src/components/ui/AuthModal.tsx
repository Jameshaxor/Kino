        ...
        <>
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md bg-bg-surface border border-border rounded-xl shadow-2xl overflow-hidden relative"
            >
              {/* Close button */}
              <button
                onClick={onClose}
              ...
              <div className="p-8">
                ...
                <div className="mb-8 text-center">
                  ...
                  <p className="text-text-tertiary text-sm">
                    {isLogin
                      ? "Sign in to securely sync your movies across devices."
                      : "Join KINO to build your ultimate cinematic library."}
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-white text-black font-semibold text-sm py-2.5 rounded-lg hover:bg-white/90 active:scale-[0.98] transition-all disabled:opacity-50 disabled:active:scale-100"
                  >
