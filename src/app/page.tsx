          ...
          <Link href="/ai">
            <div className="relative overflow-hidden rounded-2xl border border-accent/10 p-8 md:p-14 group transition-all duration-700 hover:border-accent/25">
              ...
              <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                ...
                <div className="flex items-center gap-2 px-8 py-4 bg-white text-black font-semibold rounded-xl border border-white/20 hover:bg-gray-100 transition-all duration-300">
                  Try AI Oracle
